...
class UserController extends Controller
{
    ...
    public function print()
    {
        ...
        $pdf = PDF::loadView('pdf.users', compact('users')); // Ganti 'pdf.users' dengan nama view yang sesuai
        return $pdf->stream('users.pdf'); // Atau gunakan ->download('users.pdf') untuk mengunduh
    }
}